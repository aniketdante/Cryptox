...
txtMsg = Entry(f1, font=('arial', 17, 'bold'),
...
# labels for the key
lblkey = Label(f1, font=('arial', 17, 'bold'),
...
txtkey = Entry(f1, font=('arial', 17, 'bold'),
...
# labels for the mode
lblmode = Label(f1, font=('arial', 17, 'bold'),
...
lblResult = Label(f1, font=('arial', 17, 'bold'),
                  text="The Result-", bd=16, anchor="w")

lblResult.grid(row=2, column=2)

# Entry box for the result
txtResult = Entry(f1, font=('arial', 17, 'bold'),
...
btnTotal = Button(f1, padx=16, pady=8, bd=16, fg="black",
                  ...
                  command=Results).grid(row=8, column=2)

# Reset button
btnReset = Button(f1, padx=16, pady=8, bd=16,
                  fg="black", font=('arial', 16, 'bold'),
                  width=10, text="Reset", bg="brown",
